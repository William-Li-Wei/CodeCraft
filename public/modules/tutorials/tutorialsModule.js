            ...
            resolve: {
                albums: ['$stateParams', function($stateParams) {
                    return [
                        ...
                        { name: 'We Do Code Right', introduction: '逗知识, 冷吐槽, 这个家伙很无聊; 装装逼, 扯扯蛋, 标题内容反着看.' },
                        { name: 'Database 2015', introduction: '数据库技术是非常重要的, 很多应用都离不开他, 跟我学, 121, 我们都爱肯德基!' },
                        { name: 'Java Advance', introduction: 'Java 是一门编程艺术, 讲究的是说学逗唱. 但在众多编程语言当中, Java算是较难的一只, 有很多复杂的语法和规则, 但同时提供了很多便利和安全性服务, 大家可以放心的使用它.' },
                        { name: 'Learn Python from 0', introduction: 'Python 很火唉最近, 想不想试试?' },
                        { name: 'Computer Science', introduction: '中南大学的计算机科学专业很不错哦, 大家可以试试, 但信息安全专业更棒!' }
                    ];
                }]
            }
        })
 ...
 * Controllers
 */
ccTutorials.controller('AlbumsController', ['$scope', '$state', '$stateParams', '$compile', '$window', '$document', 'albums', function($scope, $state, $stateParams, $compile, $window, $document, albums) {
    $scope.albums = albums;
